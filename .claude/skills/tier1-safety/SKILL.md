---
name: tier1-safety
description: Tier1 safety protocols -- tier taxonomy, hard limits, confidence criteria, rollback patterns. Preloaded into domain agents via skills: frontmatter.
...
> **Injection Note:** This content is injected into domain agents via skills: [tier1-safety] frontmatter. It is not loaded via Read tool -- it is embedded directly.
